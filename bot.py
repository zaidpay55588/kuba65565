...
E_STAR    = '<tg-emoji emoji-id="5429402505508003195">⭐</tg-emoji>'
E_SPARKLE = '<tg-emoji emoji-id="5427185078980288846">✨</tg-emoji>'
E_ROCKET  = '<tg-emoji emoji-id="5427179044568015509">🚀</tg-emoji>'
E_LIGHT   = '<tg-emoji emoji-id="5373042129942636402">⚡</tg-emoji>'
E_GEM     = '<tg-emoji emoji-id="5465384210928377196">💎</tg-emoji>'
...
def get_main_keyboard():
    ...
    markup.add(
             InlineKeyboardButton("💦𝙈𝙊𝙈 & 𝙎𝙊𝙉 𝙑𝙀𝘿𝙄𝙊𝙎 🫦 — ₹69 / 30d", callback_data="p1"),
